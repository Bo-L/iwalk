...
public class Login extends AppCompatActivity implements View.OnClickListener{
    ...
    private ImageView voice_accout;
    private ImageView voice_password;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voice_accout=(ImageView)findViewById(R.id.imageView3);
        voice_password=(ImageView)findViewById(R.id.imageView4);
